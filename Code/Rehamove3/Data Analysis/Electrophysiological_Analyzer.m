...
%fvtool(hpFilt)
%% Import File
filename = "/Users/KevinTang/Desktop/UTAustin/Code/GitHub/labstreaminglayer/Code/Rehamove3/Data Analysis/Data/JJ_tFUS_80.csv";
...
%% Extract Epochs and Plot Grand Averages
...
function plot_epochs(ep,fs)
    ...
    axis([-inf inf -5 5])
    rectangle('Position',[-100 -10000 500 4000], 'FaceColor',[0.3010 0.7450 0.9330])
    axis([-inf inf -1e4 4e4])
    ylabel('EEG Amplitude (uV)')
    xlabel('Time (ms)')
    set(gca,'FontSize', 14, 'LineWidth', 1)
end
