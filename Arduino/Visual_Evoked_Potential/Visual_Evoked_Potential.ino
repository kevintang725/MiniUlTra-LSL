...
const unsigned long stimulation_period = 300; 
const unsigned long rest_period = 2500; 
...
const unsigned long single_pulse_ON_micros = 1000;
const unsigned long single_pulse_OFF_micros = 1000;
